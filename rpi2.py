#author Timothy Do
#RPiMorse Pi Version for Python 2: Flashes LED in Morse Code
...
def main():
	print("Welcome to RPiMorse for Python2! It will convert your input into Morse Code (no Spanish characters) and flashes to an LED Circuit.")
	prompt()
